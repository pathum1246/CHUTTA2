...
\033[1;92m┃┃╱┃┃╱╱╱╱╱┃┃╱╱╱╱╱╱╱┃╭╮┃
\033[1;92m┃╰━╯┣━━┳━━┫┃╭┳━━┳━╮┃╰╯╰┳━━┳━━┳━━╮
\033[1;92m┃╭━╮┃╭╮┃╭━┫╰╯┫┃━┫╭╯┃╭━╮┃╭╮┃━━┫━━┫ 0781782649
\033[1;92m┃┃╱┃┃╭╮┃╰━┫╭╮┫┃━┫┃╱┃╰━╯┃╰╯┣━━┣━━┃
\033[1;92m╰╯╱╰┻╯╰┻━━┻╯╰┻━━┻╯╱╰━━━┻━━┻━━┻━━╯                                            
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER   : CHUTTA
\033[1;91m➣ Github  : 
\033[1;91m➣ GANG    : CHUTTA GANG
\033[1;91m➣ Youtube : CHUTTA
\033[1;91m➣ WhatsApp: 0781782649
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def Token_token():
	...
	print("")
	try:
		tok = open('/sdcard/Download/.CH.txt', 'r').read()
		dec = base64.b64decode(tok)
		if len(dec) < 50:
		    not_reg()
		r = requests.get("https://github.com/pathum1246/CHUTTA2/blob/main/Active.txt").text
		if dec in r:
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.CH.txt', 'w')
    ...
    print("")
    raw_input("  \t  \033[1;93m Press enter to check again ")
    os.system('xdg-open https://wa.me/+94781782649) #whatsapp number here
    Token_token()
